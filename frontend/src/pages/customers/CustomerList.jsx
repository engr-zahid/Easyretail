    ...
    return (
      <div className={`${isDarkMode ? 'warm-bg-dark' : 'warm-bg'} min-h-screen flex items-center justify-center p-4`}>
        <div className="text-center">
          ...
          <p className={`text-sm sm:text-lg font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Loading customers...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="px-4 sm:px-6 pt-4 sm:pt-8 pb-4 sm:pb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="animate-slide-up">
            ...
            <p className={`mt-1 sm:mt-2 text-sm sm:text-lg flex items-center gap-2 ${isDarkMode ? 'text-blue-300' : 'text-blue-800'}`}>
              {customers.length === 0 ? 'No customers yet' : `Managing ${customers.length} customers`}
              <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-blue-500 animate-float" />
            </p>
          </div>
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <button 
              onClick={handleExport}
              className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 animate-slide-up text-sm sm:text-base"
      ...
      <div className="px-4 sm:px-6 pb-4 sm:pb-8">
                ...
                <div className="flex sm:hidden items-center gap-2 mb-3">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className={`pl-10 pr-4 py-2 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm ${isDarkMode ? 'dark-input-bg dark-border-light dark-placeholder border-blue-800 focus:ring-blue-400' : 'border-blue-200 bg-white'}`}
                    />
                  </div>
                  <button
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                    <div className="w-full sm:flex-1 hidden sm:block">
                      <div className="relative">
                        ...
                        <input
                          ...
                          value={search}
                          onChange={(e) => setSearch(e.target.value)}
                          className={`pl-10 pr-4 py-2 sm:py-3 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base ${isDarkMode ? 'dark-input-bg dark-border-light dark-placeholder border-blue-800 focus:ring-blue-400' : 'border-blue-200 bg-white'}`}
                        />
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
                      <select 
                        ...
                        className={`px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base w-full sm:w-auto ${isDarkMode ? 'dark-input-bg dark-border-light dark-placeholder border-blue-800 focus:ring-blue-400' : 'border-blue-200 bg-white'}`}
                      >
                      ...
                      <button 
                        ...
                        className={`flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 font-medium rounded-lg transition-all duration-300 hover:scale-105 text-sm sm:text-base ${isDarkMode ? 'bg-blue-900 hover:bg-blue-800 text-blue-100' : 'bg-blue-100 hover:bg-blue-200 text-blue-800 hover:text-blue-900'}`}
                      >
        ...
        {customers.length > 0 ? (
          <div className={`${isDarkMode ? 'card-border-dark' : 'card-border'} mb-6 sm:mb-8`}>
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'}`}>
              <div className={`p-3 sm:p-5 border-b ${isDarkMode ? 'border-blue-800' : 'border-blue-100'}`}>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <div>
                    <h2 className={`text-base sm:text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>All Customers</h2>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-2">
                    ...
                    <div className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                      ...
                      <span className={`font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-900'}`}>{paginatedCustomers.length}</span>
              ...
              <div className="sm:hidden space-y-3 p-2">
                {paginatedCustomers.map((customer) => (
                  <div key={customer.id} className={`p-3 rounded-lg ${isDarkMode ? 'bg-gray-800/60' : 'bg-white'} border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div className="h-8 w-8 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 flex items-center justify-center text-white text-sm">
                          {getAvatarEmoji(customer.name)}
                        </div>
                        <div>
                          <div className={`font-medium text-sm ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>{customer.name}</div>
                          <div className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>{customer.email}</div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-2 text-xs">
                      <div className={`${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                        ...
                        {customer.phone.length > 15 ? customer.phone.substring(0, 15) + '...' : customer.phone}
                      </div>
                      <div className={`${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                    ...
                    <div className="flex items-center justify-end gap-2 mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                      <button onClick={() => { setSelectedCustomer(customer); setShowViewModal(true); }} className="p-2 rounded-lg hover:bg-blue-50/50">
                        <Eye className={`h-4 w-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`} />
                      </button>
                      <button onClick={() => { setSelectedCustomer(customer); setShowEditModal(true); }} className="p-2 rounded-lg hover:bg-blue-50/50">
                        <Edit className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                      </button>
                      <button onClick={() => { setSelectedCustomer(customer); setShowDeleteModal(true); }} className="p-2 rounded-lg hover:bg-red-50/50">
                          ...
                          <button
                            ...
                            className={`px-2 py-1 rounded-lg font-medium transition-all duration-300 text-xs ${
                              currentPage === pageNum
                                ...
                                : (isDarkMode ? 'border border-gray-700 bg-gray-800 text-gray-300 hover:bg-blue-900/30' : 'border border-gray-300 bg-gray-50 text-gray-700 hover:bg-blue-50/50')
                            }`}
                          >
                            {pageNum}
                          </button>
          ...
          <div className={`${isDarkMode ? 'card-border-dark' : 'card-border'} mb-8`}>
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'}`}>
              <div className="p-4 sm:p-8 text-center">
                <div className="mx-auto w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-r from-blue-200/30 to-cyan-200/30 dark:from-blue-900/30 dark:to-cyan-900/30 flex items-center justify-center mb-4 animate-float">
                  <Users className="h-6 w-6 sm:h-10 sm:w-10 text-blue-500 dark:text-blue-400" />
                </div>
                <h3 className={`text-lg sm:text-xl font-bold mb-2 ${isDarkMode ? 'gradient-text-dark' : 'gradient-text'}`}>
                  No Customers Yet
                </h3>
                <p className={`text-sm sm:text-base mb-6 max-w-md mx-auto px-4 ${isDarkMode ? 'text-blue-300/70' : 'text-blue-800/70'}`}>
            ...
            <div className={`${isDarkMode ? 'card-border-dark' : 'card-border'}`}>
              <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'}`}>
                <div className="p-4 sm:p-6">
                  <h3 className={`text-base sm:text-lg font-bold mb-3 sm:mb-4 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Customer Insights</h3>
                  <div className="space-y-3">
                    {quickStats.map((stat, index) => (
                      <div key={stat.label} className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-gradient-to-r from-blue-50/30 to-cyan-50/30 dark:from-blue-900/20 dark:to-cyan-900/20">
              ...
              <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'}`}>
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <button 
                      onClick={() => setShowAddModal(true)}
                      className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 text-xs sm:text-sm"
                    >
                      <UserPlus className="h-3 w-3 sm:h-4 sm:w-4" />
                      Add New Customer
                    </button>
                    <button 
                      onClick={handleExport}
                      className={`w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 font-medium rounded-lg border transition-all duration-300 hover:scale-105 text-xs sm:text-sm ${isDarkMode ? 'bg-gray-800 hover:bg-blue-900/30 text-gray-300 hover:text-gray-100 border-gray-700' : 'bg-gray-50 hover:bg-blue-50 text-gray-700 hover:text-gray-900 border-gray-300'}`}
                    >
                      <Download className="h-3 w-3 sm:h-4 sm:w-4" />
                      Export Customers
                    </button>
            ...
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'}`}>
              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-4">
                  ...
                  <div>
                    <h3 className={`text-base sm:text-lg font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Delete Customer</h3>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                  <button
                    ...
                    className={`px-3 sm:px-4 py-2 sm:py-2.5 font-medium rounded-lg border transition-all duration-300 hover:scale-105 text-xs sm:text-sm ${isDarkMode ? 'bg-gray-800 hover:bg-blue-900/30 text-gray-300 hover:text-gray-100 border-gray-700' : 'bg-gray-50 hover:bg-blue-50/50 text-gray-700 hover:text-gray-900 border-gray-300'}`}
                  >
                    Cancel
                  </button>
                  <button
            ...
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'} max-h-[90vh] overflow-y-auto`}>
              <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-r from-blue-500/20 to-cyan-500/20 dark:from-blue-500/30 dark:to-cyan-500/30 flex items-center justify-center">
                      <UserPlus className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 dark:text-blue-400" />
                    </div>
                    <div>
                      <h3 className={`text-base sm:text-lg font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Add New Customer</h3>
                      <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Create a new customer entry</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${isDarkMode ? 'dark-input-bg dark-border-light dark-placeholder' : 'border-gray-300'}`}
            ...
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'} max-h-[90vh] overflow-y-auto`}>
              <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-r from-blue-500/20 to-cyan-500/20 dark:from-blue-500/30 dark:to-cyan-500/30 flex items-center justify-center">
                      <Edit className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 dark:text-blue-400" />
                    </div>
                    <div>
                      <h3 className={`text-base sm:text-lg font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>Edit Customer</h3>
                      <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Update customer information</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
          ...
          <div className={`${isDarkMode ? 'card-border-dark' : 'card-border'} w-full sm:max-w-md md:max-w-lg`}>
            <div className={`${isDarkMode ? 'card-inner-dark' : 'card-inner'} max-h-[90vh] overflow-y-auto`}>
              <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 flex items-center justify-center text-white text-base sm:text-xl">
                      {getAvatarEmoji(selectedCustomer.name)}
                    </div>
                    <div>
                      <h3 className={`text-base sm:text-lg font-semibold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>{selectedCustomer.name}</h3>
                      <p className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Customer Details</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="grid grid-cols-2 gap-2 sm:gap-4">
                    <div className={`p-2 sm:p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-blue-50/50'}`}>
                      ...
                      <div className={`text-xs sm:text-sm break-words ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                        {selectedCustomer.email.length > 25 ? selectedCustomer.email.substring(0, 25) + '...' : selectedCustomer.email}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-4">
                    <div className={`p-2 sm:p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-blue-50/50'}`}>
                      ...
                      <div className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>{selectedCustomer.joinedDate}</div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-4">
                    <div className={`p-2 sm:p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-emerald-50/50'}`}>
                      ...
                      <div className={`text-sm sm:text-lg font-bold ${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'}`}>{selectedCustomer.totalOrders}</div>
                    </div>
                    
                    <div className={`p-2 sm:p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-emerald-50/50'}`}>
                      <div className={`text-xs font-medium mb-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Spent</div>
                      <div className={`text-sm sm:text-lg font-bold ${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'}`}>${selectedCustomer.totalSpent}</div>
                    </div>
                  </div>
                  ...
                  {selectedCustomer.notes && (
                    <div className={`p-2 sm:p-3 rounded-lg ${isDarkMode ? 'bg-gray-700/50' : 'bg-blue-50/50'}`}>
                      ...
                      <div className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{selectedCustomer.notes}</div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-300 dark:border-gray-700">
                  ...
                  <button
                    ...
                    className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-medium rounded-lg transition-colors text-xs sm:text-sm"
                  >
