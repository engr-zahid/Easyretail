      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex items-center">
            <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="w-full">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-gray-100"
              ...
              <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  <Button
                    type="submit"
                    disabled={saving}
                    className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base order-1 sm:order-2"
                  >
                    {saving ? (
                      <>
                      ...
                      <>
                        ...
                        <span className="text-sm sm:text-base">{isEditMode ? 'Update Supplier' : 'Create Supplier'}</span>
                      </>
                    )}
                  </Button>
                </div>
